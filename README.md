...
* [awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps) ⭐ 139,717 | 🐛 15 | 🌐 Python | 📅 2026-09-25 - LLM-powered applications across providers.
* [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) ⭐ 95,510 | 🐛 2,362 | 📅 2026-09-23 - Model Context Protocol servers powering many of the connectors above.
